      ...
      function _(e, t) {
        let { scriptLoader: n, disableOptimizedLoading: i, crossOrigin: o } = e,
          ...
          `
              ...
              return (
                (0, a.default)(e) && 'MODULE_NOT_FOUND' !== e.code && console.warn(`Warning: ${e.message}`),
                null
              )
            }
          })(e, t),
          ...
          return r.default.createElement(
            ...
            i &&
              r.default.createElement(
                ...
                !b &&
                  r.default.createElement('link', { rel: 'canonical', href: s + n(9505).cleanAmpPath(l) }),
                r.default.createElement('link', {
                  rel: 'preload',
                  as: 'script',
...
See more info here: https://nextjs.org/docs/messages/large-page-data`)),
    ...
    2946: (e, t) => {
      ...
      async function f(e, t) {
        ...
        if (!r) {
          let t =
            '"' + l(e) + '.getInitialProps()" should resolve to an object. But found "' + r + '" instead.'
          throw Error(t)
        }
        return r
      }
