          ...
          },
          {
            ...
            submenu: {
              ...
              items: [
                ...
                { label: 'Investments', url: '/personal-finance/investments', submenu: null },
                { label: 'Pensions', url: '/pensions', submenu: null },
                { label: 'Tax', url: '/personal-finance/tax', submenu: null },
                {
                  label: 'Banking & Savings',
                  url: '/personal-finance/banking-savings',
                  submenu: null
                },
                { label: 'Advice & Comment', url: '/personal-finance/advice-commment', submenu: null }
              ]
            }
          },
          { label: 'Science', url: '/companies/science', submenu: null },
          { label: 'Special Reports', url: '/special-reports', submenu: null }
        ]
      }
    },
    {
      ...
      submenu: {
        ...
        items: [
          { label: 'Lex', url: '/lex', submenu: null },
          { label: 'Alphaville', url: 'https://ftalphaville.ft.com', submenu: null },
          { label: 'EM Squared', url: '/emerging-markets/em-squared', submenu: null },
          { label: 'Lunch with the FT', url: '/lunch-with-the-ft', submenu: null },
          {
            label: 'FT Confidential Research',
            url: 'https://www.ft.com/ft-confidential-research',
            submenu: null
          },
          { label: 'Video', url: '/video', submenu: null },
          { label: 'Podcasts', url: 'https://www.ft.com/podcasts', submenu: null },
    ...
    },
    {
      ...
      submenu: {
        ...
        items: [
          ...
          { label: 'Crossword', url: 'https://www.ft.com/crossword', submenu: null },
          { label: 'Our Apps', url: 'https://www.ft.com/tour/apps', submenu: null }
        ]
      }
    }
  ]
