...
If the manifest file supports listing files generated for each entry point (which is the case if you are using the [Page Kit CLI](../dotcom-build-base/README.md)) this method can be used to return a list of all files organised by type.
