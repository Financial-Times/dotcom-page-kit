...
const logoLink = `<a class="o-header__top-logo" data-trackable="logo" href="/" title="Go to Financial Times homepage">
<span class="o-header__visually-hidden">Financial Times</span>
</a>`
const portfolioLink =
  '<a class="o-header__nav-link" href="https://markets.ft.com/data/portfolio/dashboard" data-trackable="Portfolio">Portfolio</a>'
const accountSettingsLink =
  '<a class="o-header__nav-link" href="https://myaccount.ft.com/details/core/view" data-trackable="Account Settings">Account Settings</a>'
const signInLink =
  '<a class="o-header__nav-link" href="/login?location=#" data-trackable="Sign In">Sign In</a>'
const subscribeLink =
  '<a class="o-header__anon-link" href="/products?segmentId=#" data-trackable="Subscribe">Subscribe</a>'
const myFTLink =
  '<a class="o-header__top-link o-header__top-link--myft" href="/myft" data-trackable="my-ft" data-tour-stage="myFt" aria-label="My F T"><span class="o-header__visually-hidden">myFT</span></a>'
